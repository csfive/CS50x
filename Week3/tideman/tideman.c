...
bool vote(int rank, string name, int ranks[])
{
    // TODO: Find the corresponding candidate and update ranks
    for (int i = 0; i < candidate_count; i++)
    {
...
void sort_pairs(void)
{
    // TODO: Compute strength and sort
...
void print_winner(void)
{
    // TODO: Winner has no element pointing to itself
    for (int i = 0; i < candidate_count; i++)
    {
        bool isLoser = false;
        for (int j = 0; j < candidate_count; j++)
